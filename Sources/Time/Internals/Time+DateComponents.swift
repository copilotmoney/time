...
extension DateComponents {
    ...
    func requireAndRestrict(to components: Set<Calendar.Component>, lenient: Set<Calendar.Component>)
    ...
    var loggingDescription: String {
        return "{"
            + Calendar.Component.numericComponents.compactMap({ unit -> String? in
