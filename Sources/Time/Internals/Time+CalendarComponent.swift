...
extension Calendar.Component {
    ...
    internal static let all: [Calendar.Component] = numericComponents + [.calendar, .timeZone]

    internal static let numericComponents: [Calendar.Component] = [
        .era, .year, .month, .day,
    ...
    internal static let ascendingOrder: [Calendar.Component] = [
        .nanosecond, .second, .minute, .hour, .day, .month, .year, .era,
    ]
    internal static let descendingOrder: [Calendar.Component] = [
    ...
    internal static func from<L: Unit, U: Unit>(lower: L.Type, to upper: U.Type) -> Set<
        Calendar.Component
    > {
