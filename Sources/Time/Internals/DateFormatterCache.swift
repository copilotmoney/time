...
extension DateFormatter {
    ...
    internal static func formatter(for templates: [Format?], region: Region) -> DateFormatter {
...
private class DateFormatterCache {
    ...
    private var formatters = [DateFormatter.Key: DateFormatter]()
