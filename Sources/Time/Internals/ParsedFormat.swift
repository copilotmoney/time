    ...
    enum FormatComponent {
        ...
        var unit: Calendar.Component? {
            ...
            case .format(let char, _):
                return Calendar.Component(formatCharacter: char).unwrap(
                    "Somehow got an invalid format character while parsing?"
                )
            case .template(let char, _):
                return Calendar.Component(formatCharacter: char).unwrap(
                    "Somehow got an invalid template character while parsing?"
                )
            }
        }
...
private let formatCharacters: Set<Character> = [
    "G", "y", "Y", "u", "U", "r", "Q", "q", "M", "L", "w", "W", "d", "D", "F", "g", "E", "e", "c",
    "a", "b", "B", "h", "H", "k", "K", "m", "s", "S", "A", "z", "Z", "O", "v", "V", "X", "x",
]
