...
extension Fixed where Granularity: LTOEDay {
    ...
    public var dayOfYear: Int {
        return calendar.ordinality(of: .day, in: .year, for: approximateMidPoint.date)!
    }
    ...
    public var dayOfWeekOrdinal: Int {
        return calendar.component(.weekdayOrdinal, from: approximateMidPoint.date)
    }
    ...
    public var weekOfMonth: Int {
        return calendar.component(.weekOfMonth, from: approximateMidPoint.date)
    }
    ...
    public var weekOfYear: Int {
        return calendar.component(.weekOfYear, from: approximateMidPoint.date)
    }
}
